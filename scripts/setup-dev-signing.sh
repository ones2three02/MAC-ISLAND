#!/bin/zsh
#
# Create a local self-signed code signing identity for Mac Island dev
...
IDENTITY_NAME="Mac Island Dev Local"
...
echo "you give Mac Island Dev will persist across rebuilds."
