...
How to cut a new GitHub release for Mac Island.
...
2. **Build & package**:
   ...
   ```
   This produces `output/package/Mac Island.dmg` and `output/package/Mac Island.zip`.
...
6. **Create the release**:
   ...
   gh release create v<version> \
     "output/package/Mac Island.dmg#Open.Island.dmg" \
     "output/package/Mac Island.zip#Open.Island.zip" \
     --target main \
     --title "Mac Island v<version> — <Title>" \
...
1. Download **Mac Island.dmg**, open it, and drag **Mac Island** to **Applications**.
   下载 **Mac Island.dmg**，打开后将 **Mac Island** 拖入 **Applications**。

2. Since this is an unsigned app, macOS will show **"Mac Island is damaged"** when you try to open it. Run this command in Terminal to fix it:
   由于应用未签名，macOS 会提示**「"Mac Island"已损坏」**。请在终端中执行以下命令：

   ```bash
   xattr -dr com.apple.quarantine "/Applications/Mac Island.app"
   ```
...
| File | Purpose |
|------|---------|
| `Mac Island.dmg` | Styled disk image with drag-to-Applications |
| `Mac Island.zip` | Plain zip for automation / CI downloads |
...
```
https://raw.githubusercontent.com/ones2three02/MAC-ISLAND/main/appcast.xml
```
...
<item>
    ...
    <enclosure
        url="https://github.com/ones2three02/MAC-ISLAND/releases/download/vX.Y.Z/Open.Island.zip"
