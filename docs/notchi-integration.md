...
[`notchi`](https://github.com/sk-ruban/notchi) is a strong adjacent reference for Mac Island:
...
Mac Island should learn from that execution without collapsing into a Claude-specific mascot app.
...
That is a useful product pattern for Mac Island:

1. ambient awareness in the notch
2. actionable detail on expand
3. local transport and setup automation underneath

## Where Mac Island Should Differ

Notchi is optimized for Claude Code presence and delight. Mac Island should stay optimized for control.

Mac Island should keep these distinctions:
...
Mac Island already has the beginning of the Codex side:
...
Mac Island should do a control-oriented version of that:
...
Mac Island can adopt that idea in a more neutral form:
...
Notchi demonstrates that a narrow first integration is enough to ship. Mac Island should still keep its bridge generic so Claude Code or other agents can be added later as adapters.
...
That would capture the highest-leverage lessons from Notchi while staying aligned with Mac Island's stated product direction.
...
Those features may help Notchi's product identity, but they are not on Mac Island's current critical path.
