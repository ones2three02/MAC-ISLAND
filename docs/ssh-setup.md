...
Connect Mac Island to Claude Code running on a remote server over SSH.
...
- Mac Island running on your Mac
...
1. Make sure Mac Island is running on your Mac
2. SSH to the remote with socket forwarding enabled
3. Run Claude Code on the remote — sessions should appear in the Mac Island overlay
...
- Make sure Mac Island is running locally before establishing the SSH connection
