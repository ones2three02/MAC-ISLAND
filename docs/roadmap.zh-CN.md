...
Mac Island 由社区驱动。我们相信最好的产品体验会由每个工具的深度用户创造。欢迎任何形式的贡献——选一个你感兴趣的方向，开始 vibe。

你可以认为 Mac Island 做了那些最基础的事：一个 mac island 的壳子 + code agent 通信层 + 基础的功能如通知/终端跳转，其他的一切都可以由你定义。
...
> 2. 在有任意代码（或其他形式的贡献）被合并后，你可以选择成为 maintainer 之一，只需要联系 [@ones2three02](https://github.com/ones2three02)（你可以通过邮箱 ones2three@gmail.com 找到我）。
...
| 2 | **IDE / 插件跳转** | 支持跳转回 IDE 或 IDE 内 terminal，或集成了 code agent 插件的 app 窗口（Cursor、VSCode、GoLand、Obsidian 等）。 | 已规划 | [#173](https://github.com/ones2three02/MAC-ISLAND/issues/173), [#183](https://github.com/ones2three02/MAC-ISLAND/issues/183) |
