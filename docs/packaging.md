...
- The script creates `output/package/Mac Island.app`.
...
- The script also creates `output/package/Mac Island.zip` for local sharing or later notarization.
...
### "Mac Island is damaged and can't be opened"
