# Contributing to Mac Island

<a href="CONTRIBUTING.zh-CN.md">中文</a> | <strong>English</strong>

Thank you for your interest in contributing to Mac Island!
...
```
I'd like to request a feature for Mac Island (https://github.com/ones2three02/MAC-ISLAND).
...
Mac Island is a native macOS companion app for AI coding agents. It sits in the notch/top-bar area and monitors local agent sessions, surfaces permission requests, answers questions, and provides "jump back" to the correct terminal context. Local-first, no server dependency.
