...
public struct HookHealthReport: Equatable, Sendable {
    ...
    public enum Issue: Equatable, Sendable, CustomStringConvertible {
        ...
        /// Other hooks detected alongside Mac Island hooks (informational).
...
public enum HookHealthCheck {
        ...
        for (_, eventValue) in hooks {
            ...
            for group in groups {
                ...
                for hook in hookEntries {
                    ...
                    // Only check Mac Island / Vibe Island commands
    ...
    /// Finds third-party (non-Mac Island) hook command names for display.
        ...
        for (_, eventValue) in hooks {
            ...
            for group in groups {
                ...
                for hook in hookEntries {
                    ...
                    // Skip Mac Island / Vibe Island hooks
    ...
    /// Checks whether any Mac Island managed hooks exist in a config file.
